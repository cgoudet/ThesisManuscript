...
%%   \begin{itemize}
%%   \item Calibration constants required before run 2 data
%%   \item \textcolor{red}{\bf Pre-recommandations computed from 8 TeV data and run 2 algorithms}
%%   \end{itemize}
%% \end{minipage}
%% \vfill
...
%%   \begin{minipage}{0.8\linewidth}
%%   \begin{itemize}
%%   \item {\bf Good agreement with run 1 in the barrel}
%%   \end{itemize}
%% \end{minipage}

%% \end{frame}
%% %%===================================
%% \begin{frame}{Run 2 pre-recommandations uncertainties}
%% \centering
%% \begin{minipage}{0.7\linewidth}
%%   \begin{itemize}
%%   \item Run 1 calibration uncertainties conserved
%%   \item \textcolor{red}{\bf Conservative uncertainties added} (IBL, Binning)
%%   \end{itemize}
%% \end{minipage}
%% \vfill
%%   \begin{minipage}[t]{0.49\linewidth} 
...
%%   \begin{itemize}
%%   \item {\bf New systematics highly dominant ($>100\%$ uncertainty)}
%%   \end{itemize}
%% \end{minipage}
...
\begin{frame}{Run 2 closure uncertainty}
  \begin{itemize}
  \item Pseudo experiment have been performed
