...
\color{blue!20!red!45!black} %% Couleur violette du premier paragraphe
  \begin{center}
    ...
    \LARGE{\textsc{préparée à l' \PhDworkingplace}} \\ \bigskip
...
\begin{tabular}{llll}
    ...
    \jurygenderB & \jurynameB  & \jurygradeB & \juryroleB \\
    %\null &\\

    \jurygenderC & \jurynameC  & \jurygradeC & \juryroleC \\
    %\null &\\

    \jurygenderD & \jurynameD  & \jurygradeD & \juryroleD \\
    %\null &\\

    \jurygenderE & \jurynameE  & \jurygradeE & \juryroleE \\
    %\null &\\
    \jurygenderA & \jurynameA  & \jurygradeA & \juryroleA \\
    %\null & \null & \juryadressA &\\
    \jurygenderF & \jurynameF  & \jurygradeF & \juryroleF \\
    %\null &\\

  \jurygenderG & \jurynameG  & \jurygradeG & \juryroleG \\
    %\null &\\
...
\begin{textblock}{10}(1.83,15.4)
\small Laboratoire de l'Accélérateur Linéaire  LAL 17-XXX
%\label{LAL-BU}
\end{textblock}
