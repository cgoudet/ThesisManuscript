...
\begin{document}
\includepdf[pages={1}]{PageDeGarde/coverEn.pdf}
...
\include{Chapters/InSitu}
\include{Chapters/HGam}
...
\include{Appendices/InversionMatrix}
\include{Appendices/Chi2ToyModel}
...
%----------------------------------------------------------------------------------------
\include{Appendices/Remerciements}

\include{Appendices/Resume}
